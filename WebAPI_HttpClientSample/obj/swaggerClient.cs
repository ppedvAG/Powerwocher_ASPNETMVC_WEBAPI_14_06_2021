...
namespace WebAPI_HttpClientSample
{
    ...
    public partial class swaggerClient 
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Movie>> MovieAllAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Movie");
    ...
    public partial class MovieCast 
    {
        ...
        [Newtonsoft.Json.JsonProperty("artistI", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
